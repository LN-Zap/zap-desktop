...
export default defineMessages({
  ...
  wallet_settings_name_description: 'The wallet name is only visible to you inside Zap.',
  wallet_settings_name_placeholder: 'Enter name',
  wallet_settings_alias_label: 'Alias',
  wallet_settings_alias_description: 'The alias is visible to others on the network.',
  ...
  create_wallet_prompt: 'Start creating one from here:',
