...
export default defineMessages({
  ...
  base_fee_description:
    'The required number of {cryptoName} per kilo-weight that the requester will pay at all times, for both the funding transaction and commitment transaction.',
